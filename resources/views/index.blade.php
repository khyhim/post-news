        ...
        <a class="get" rel="{{ $socialsefts->id }}" href="{{route('pressrelease',$socialsefts->id)}}?pressrelease={{$socialsefts->categories_id}}">
          ...
          <div class="mean-decription">
            <div class="decription">
              ...
              <div class="date">
                <div class="pub-date" date="{{ $socialsefts->created_at->format('l j F Y H:i:s')}}" style="float:left;">{{ $socialsefts->created_at->format('d/m/Y')}} </div>
              </div>
            </div>
          </div>
          ...
          <div class="web">
           ...
           @foreach ($potstag as $potstags) 
              ...
              <div class="col-sm-4 item">
                <a class="get" rel="{{ $potstags->id }}" href="{{route('tagrelease',$potstags->id)}}?tagrelease={{$potstags->tag_id}}">
                    <div class="box ratio16_9"> 
                    <div class="ele lozad" data-background-image="{{asset('')}}/{{$potstags->images}}" data-loaded="true" style="background-image: url('{{asset('')}}/{{$potstags->images}}');"></div>
